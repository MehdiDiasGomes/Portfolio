<template>
  <Sheet>
    ...
    <SheetContent class="bg-[#000319] border-l overflow-y-scroll border-borderPerso w-full sm:w-7/12">
      <SheetHeader>
          ...
          <div class="flex flex-col gap-6">
            ...
            <div>
              ...
              <div class="flex flex-wrap gap-3">
                <div v-for="(tech, index) in data.iconTech" :key="index"
