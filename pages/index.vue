<template>
  <div class="relative overflow-hidden">
    ...
    <div class="flex min-h-screen items-center justify-center relative z-10 pt-20">
      <div class="max-w-[1100px] p-10 md:p-0 flex flex-col items-center justify-center gap-12 mx-auto text-center">
        ...
        <div class="fade-in flex gap-4 flex-wrap justify-center" style="animation-delay: 0.2s">
          <Button
            variant="primary"
            :content="$t('landing.cta.portfolio')"
            icon="FolderGit2"
            href="/portfolio"
          />
          <Button
            variant="secondary"
            :content="$t('landing.cta.contact')"
            icon="Mail"
            href="/contact"
          />
        </div>

        <div class="fade-in mt-8" style="animation-delay: 0.4s">
          <ButtonScroll side="bottom" />
        </div>
      </div>
    </div>
  </div>
